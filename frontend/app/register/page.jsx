...
import { BookOpen, Eye, EyeOff, ArrowLeft, User, Mail, Lock, Shield } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50 to-emerald-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 leading-relaxed">Create your account and start exploring</p>
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 text-center">
              <p className="text-slate-600">
                ...
                <Link href="/login" className="text-emerald-600 hover:text-emerald-500 font-semibold hover:underline transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
